...
public class PostRegisterSuccessTest {
    private final ObjectMapper objectMapper = new ObjectMapper();

    @ParameterizedTest
    @CsvSource({
            "'eve.holt@reqres.in', 'inferno', 'JAPAN', true",
            "'lindsay.ferguson@reqres.in', 'inferno', 'USA', true",
            "'lindsay.ferguson@reqres.in', 'inferno', 'RUSSIA', true",
            "'tobias.funke@reqres.in', 'inferno', 'Canada', true",
    ...
    public void testRegisterSuccess(String email, String password, String state, boolean isSuccess) throws JsonProcessingException {
        String BASE_URL = "https://reqres.in/api/register";
        ...
        if (isSuccess) {
            ...
            assertTrue(registerResponse.getId()>0, "ID должен быть положительным");
